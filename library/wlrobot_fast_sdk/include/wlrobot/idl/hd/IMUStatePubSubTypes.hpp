...
#ifndef FAST_DDS_GENERATED__WLROBOT_MSG_IMUSTATE_PUBSUBTYPES_HPP
#define FAST_DDS_GENERATED__WLROBOT_MSG_IMUSTATE_PUBSUBTYPES_HPP
...
namespace wlrobot
{
    namespace msg
    {
         ...
         * @ingroup IMUState
         */
        class IMUStatePubSubType : public eprosima::fastdds::dds::TopicDataType
        {
        public:

            typedef ::wlrobot::msg::IMUState type;

            eProsima_user_DllExport IMUStatePubSubType();

            eProsima_user_DllExport ~IMUStatePubSubType() override;
...
#endif // FAST_DDS_GENERATED__WLROBOT_MSG_IMUSTATE_PUBSUBTYPES_HPP
