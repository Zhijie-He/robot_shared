/****************************************************************
  ...
  Source: RobotstateSwitch_.cpp
  Cyclone DDS: v0.10.5

*****************************************************************/
#include "wlrobot/idl/hg/RobotstateSwitch_.hpp"
...
propvec &get_type_props<::agile::msg::dds_::RobotstateSwitch_>() {
  ...
  props.push_back(entity_properties_t(1, 0, false, get_bit_bound<uint8_t>(), extensibility::ext_final, false));  //::switch_mode
