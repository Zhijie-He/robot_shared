/****************************************************************
  ...
  Source: MotorCmd_.cpp
  Cyclone DDS: v0.10.5

*****************************************************************/
#include "wlrobot/idl/hg/MotorCmd_.hpp"
...
propvec &get_type_props<::agile::msg::dds_::MotorCmd_>() {
  ...
  props.push_back(entity_properties_t(1, 0, false, get_bit_bound<uint32_t>(), extensibility::ext_final, false));  //::mode
