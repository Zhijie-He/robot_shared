/****************************************************************
  ...
  Source: GimbalControl_.cpp
  Cyclone DDS: v0.10.5

*****************************************************************/
#include "wlrobot/idl/hg/GimbalControl_.hpp"
...
propvec &get_type_props<::agile::msg::dds_::GimbalControl_>() {
  ...
  props.push_back(entity_properties_t(1, 0, false, get_bit_bound<int16_t>(), extensibility::ext_final, false));  //::op_value
